...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Models write to file
    |--------------------------------------------------------------------------
    |
    | When true, write the model information to the models file.
    |
    */
    ...
    */
    ...
    'magic' => [
        'Log' => [
            'debug' => 'Psr\Log\LoggerInterface::debug',
            'info' => 'Psr\Log\LoggerInterface::info',
            'notice' => 'Psr\Log\LoggerInterface::notice',
            'warning' => 'Psr\Log\LoggerInterface::warning',
            'error' => 'Psr\Log\LoggerInterface::error',
            'critical' => 'Psr\Log\LoggerInterface::critical',
            'alert' => 'Psr\Log\LoggerInterface::alert',
            'emergency' => 'Psr\Log\LoggerInterface::emergency',
        ]
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Override the default model namespace with full path
    |
    */
